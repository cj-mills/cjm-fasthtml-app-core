...
# %% ../../nbs/components/navbar.ipynb #b1809537
...
# %% ../../nbs/components/navbar.ipynb #65e0b5b3
...
# %% ../../nbs/components/navbar.ipynb #334f5d72
def create_navbar(
    ...
    **navbar_kwargs # Additional kwargs for navbar styling
    ...
    mobile_nav_items = Ul(
        *[Li(_create_nav_link(label, route, target_id)) for label, route in nav_items],
        tabindex="0",
        cls=combine_classes(
            menu,
            dropdown_content,
